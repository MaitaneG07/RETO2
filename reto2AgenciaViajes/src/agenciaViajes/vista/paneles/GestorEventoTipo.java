...
public class GestorEventoTipo  {
	...
	public GestorEventoTipo(ArrayList<JPanel> paneles) {
		...
		comboBoxTipo.setModel(new DefaultComboBoxModel(new String[] {"ALOJAMIENTO", "VUELO", "ACTIVIDAD"}));
		comboBoxTipo.setBounds(309, 128, 130, 27);
		gestorEventoTipo.add(comboBoxTipo);
		
		lbTipoHabitacion = new JLabel("TIPO HABITACIÓN");
		...
		comboBoxHabitacion.setFont(new Font("Tahoma", Font.PLAIN, 11));
