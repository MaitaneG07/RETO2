...
public class GestorNuevoViaje {
	...
	public GestorNuevoViaje(ArrayList<JPanel> paneles) {
		...
		JLabel lblInicioViaje = new JLabel("INICIO DE VIAJE");
		...
		JLabel lblFinViaje = new JLabel("FIN DE VIAJE");
		...
		JLabel lblServiciosNoIncluidos = new JLabel("SERVICIOS NO INCL.");
		...
		btnGuardar.setBounds(185, 611, 104, 23);
		...
		btnCancelar.setBounds(299, 611, 104, 23);
