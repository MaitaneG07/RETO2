    ...
    <main>
        ...
        <form id="formulario_viajes" class="formulario" method="POST" action="zerbitzuak_gorde.php">
            ...
            <div id="seccion_ida" style="display:none;">
                ...
                <input type="date" id="fecha_salida" name="fecha_salida" placeholder="AAAA-MM-DD" required/><br><br>
            ...
            <div id="seccion_vuelta" style="display:none;">
                ...
                <input type="date" id="fecha_vuelta" name="fecha_vuelta" placeholder="AAAA-MM-DD" /><br><br>
            ...
            <div id="seccion_hotel" style="display:none;">
                ...
                <input type="date" id="fecha_salida" name="fecha_salida" placeholder="AAAA-MM-DD"/><br><br>
            ...
            <div id="seccion_otros" class="seccion" style="display:none;">
                ...
                <input type="date" id="fecha_otros" name="fecha_salida" placeholder="AAAA-MM-DD"/><br><br>
