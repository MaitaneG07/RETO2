...
<header>
    ...
    <main>
        ...
        <form id="formulario_registro" class="formulario" method="POST" action="bidaia_gorde.php">
            ...
            <input type="date" id="fecha_entrada" name="fec_ini" onchange="calcularDias()"/>
            </div><br><br>
            
            
            <label for="fecha_fin">Fecha fin</label>
            <div id="fecha_salida">
            <input type="date" id="fecha_salida" name="fec_fin" onchange="calcularDias()"/>
            </div><br></br>
            
            
            <label for="dias">Días</label>
            <div id="dias">
            <input type="text" id="dias" name="duracion" maxlength="30" readonly/>
            </div><br><br>
